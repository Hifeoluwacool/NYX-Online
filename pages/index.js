...
export default function Home({ data }) {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>NYX Online</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      {/* <div className="banner p-2">
        <div className="py-1 ">
          <span className=" font-bold py-5">NYX News</span> is where your earn
          your passive income for posting and reading
        </div>
        <span className="banner_label text-xs ">
          <span className="bg-yellow-500 p-1 text-white font-bold">New</span>{" "}
          Join today and started earning by posting as an author and as a ready
        </span>
      </div>
      <main>
        <PostCard />
      ...
      <main className="layout_container main_lay  ">
        <section className="bg-white  py-5 childy xl:rounded-md p-5 ">
          <div className="banner p-2">
            <div className="py-1 ">
              <span className=" font-bold py-5">NYX News</span> is where your
